/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 72aed85206d1e87184d5940da3811111)
...
interface __BaseEnv_Env {
	...
	INTEGRATION_WEBHOOK_ALLOWED_HOSTS: string;
	REDIS_URL: string;
	S3_ENDPOINT: string;
	S3_REGION: string;
	S3_BUCKET: string;
	...
	FFAI_API: DurableObjectNamespace<import("./src/cloudflare").FfaiApiContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/cloudflare");
		durableNamespaces: "FfaiApiContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "JWT_ACCESS_SECRET" | "JWT_REFRESH_SECRET" | "JWT_ACCESS_TTL" | "JWT_REFRESH_TTL" | "PORT" | "WEB_ORIGIN" | "NEXT_PUBLIC_API_URL" | "INTEGRATION_ENCRYPTION_KEY" | "INTEGRATION_WEBHOOK_ALLOWED_HOSTS" | "REDIS_URL" | "S3_ENDPOINT" | "S3_REGION" | "S3_BUCKET" | "S3_ACCESS_KEY_ID" | "S3_SECRET_ACCESS_KEY">> {}
}
